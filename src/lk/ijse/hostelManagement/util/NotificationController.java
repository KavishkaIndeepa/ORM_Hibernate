...
public class NotificationController {
    public static void SuccessfulTableNotification(String option, String option2) {
        Notifications notificationBuilder = Notifications.create()
                ...
                .graphic(new ImageView(new Image("/lk/ijse/hostelManagement/view/assests/Done.png")))
    ...
    public static void UnSuccessfulTableNotification(String option, String option2) {
        Notifications notificationBuilder = Notifications.create()
                ...
                .graphic(new ImageView(new Image("/lk/ijse/hostelManagement/view/assests/Wrong.png")))
                .hideAfter(Duration.seconds(8))
                .position(Pos.BOTTOM_RIGHT);
        notificationBuilder.darkStyle();
        notificationBuilder.show();
    ...
    public static void WarringError(String option, Object id, String option2) {
        Notifications notificationBuilder = Notifications.create()
                .title(option)
                .text(option2 + id)
                .graphic(new ImageView(new Image("/lk/ijse/hostelManagement/view/assestsWrong.png")))
                .hideAfter(Duration.seconds(8))
                .position(Pos.BOTTOM_RIGHT);
        notificationBuilder.darkStyle();
        notificationBuilder.show();
